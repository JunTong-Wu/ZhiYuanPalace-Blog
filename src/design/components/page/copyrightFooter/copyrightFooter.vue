    ...
    <div w-centered mx-auto>
      <div grid grid-cols-6 gap-x-7 gap-y-14 pt-12 pb-6 md:grid-cols-12>
        <div col-span-full sm:col-span-3 md:col-span-4>
          ...
          <!-- Socials -->
          <div flex space-x-5>
            <a href="#" color-text-4 hover:color-text-1>
              <ZyIcon
                  size="1.5rem"
                  lineName="simple-icons:qzone"
              />
            </a>
            <a href="#" color-text-4 hover:color-text-1>
              <ZyIcon
            ...
            <a href="#" color-text-4 hover:color-text-1>
              <ZyIcon
                  size="1.5rem"
                  lineName="ri:wechat-fill"
              />
            </a>
            <a href="#" color-text-4 hover:color-text-1>
              <ZyIcon
                  size="1.5rem"
                  lineName="ri:weibo-fill"
              />
            </a>
            <a href="#" color-text-4 hover:color-text-1>
              <ZyIcon
                  size="1.5rem"
                  lineName="ri:tiktok-fill"
              />
            </a>
          </div>
        </div>
      </div>
      <div flex flex-col items-center justify-between space-y-2 py-8 sm:flex-row sm:space-y-0>
          <span text-xs xs:text-base>
            © 2024 知鸢宫 版权所有
          </span>
        <ul flex flex-wrap space-x-4 text-xs xs:text-base>
          <li><a href="https://beian.miit.gov.cn/">鄂ICP备2022016355号-1</a></li>
          <li><a href="https://icp.gov.moe/?keyword=20229918">萌ICP备20229918号</a></li>
        </ul>
      </div>
    </div>
  </footer>
