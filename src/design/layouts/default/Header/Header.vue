    ...
    <div flex justify-between h-full>
      <div>
        <zy-button h-full px-4 @click="darkModeSwitch">
          <ZyIcon name="Navigation16" :filled="true" color="inherit" />
        </zy-button>
      </div>
