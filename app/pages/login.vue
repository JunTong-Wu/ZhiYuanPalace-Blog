<template>
  <div class="">
    <div class="translate-screen-center w-full flex flex-col items-center justify-center">
      ...
      <div
        class="bg-level-2 portrait:bg-transparent p-8 landscape:pt-12 rounded-2xl landscape:min-w-[34rem] portrait:w-full flex flex-col items-center justify-center mb-8 landscape:shadow-lg">
        ...
        <div class="flex flex-col items-center gap-8 w-full mt-4 p-4">
          <div class="flex flex-col items-center gap-8 w-full mb-8">
            <UInput v-model="username" icon="i-fluent-person-16-filled" placeholder="请输入用户名" class="w-full" size="xl"
              color="indigo"></UInput>
