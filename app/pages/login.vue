      ...
      <div
        ...
        <div class="flex flex-col items-center gap-8 w-full mt-4 p-4">
          <div class="flex flex-col items-center gap-8 w-full mb-8">
            <UInput v-model="username" icon="i-solar-user-bold" placeholder="请输入用户名" class="w-full" size="xl"
              color="indigo"></UInput>
            <UInput v-model="password" icon="i-solar-lock-bold" placeholder="请输入密码" type="password" class="w-full"
