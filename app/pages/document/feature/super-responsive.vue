  ...
  <CommonMainSection>
    <div class="document-card">
      <div class="container github-markdown-body">
        ...
        <h3>超级响应式的解决方案</h3>
        <p>
          在知鸢宫的响应式布局设计中，体验最好的做法是将响应式布局与自适应布局二者结合：<br />
          结合 TailWindCSS
          用横竖屏媒体查询处理布局切换，以及一些必要断点处的字号数值的变化。<br />
        ...
        <h3>超级响应式的断点设计</h3>
        <p>超级响应式布局系统，共可以实现以下12种屏幕尺寸的分别精细化设计：</p>
        <table>
          <thead>
            <tr>
              <th>屏幕大小（可自定义响应点）</th>
        ...
        <p>对于两个断点之间的字号的线性变化，我们可以通过以下公式来计算：</p>
        <svg
          xmlns="http://www.w3.org/2000/svg"
          width="36.36ex"
          height="5.118ex"
          viewBox="0 -1370 16071 2262"
          ...
          >
            <g data-mml-node="math">
              <g data-mml-node="mtext">
                <use xlink:href="#MJX-5-TEX-N-72"></use>
                <use
                  xlink:href="#MJX-5-TEX-N-65"
                  transform="translate(392, 0)"
                ></use>
                <use
                  xlink:href="#MJX-5-TEX-N-6D"
                  transform="translate(836, 0)"
                ></use>
              </g>
              <g
                data-mml-node="mo"
                transform="translate(1946.8, 0)"
              >
                <use xlink:href="#MJX-5-TEX-N-3D"></use>
              </g>
              <g
                data-mml-node="mtext"
                transform="translate(3002.6, 0)"
              >
                <use xlink:href="#MJX-5-TEX-N-66"></use>
                <use
                  xlink:href="#MJX-5-TEX-N-6F"
                ...
                <use
                  ...
                  transform="translate(1362, 0)"
                ></use>
                <use
                  xlink:href="#MJX-5-TEX-N-53"
                  transform="translate(1751, 0)"
                ></use>
                <use
                  xlink:href="#MJX-5-TEX-N-69"
                  transform="translate(2307, 0)"
                ></use>
                <use
                  xlink:href="#MJX-5-TEX-N-7A"
                  transform="translate(2585, 0)"
                ></use>
                <use
                  xlink:href="#MJX-5-TEX-N-65"
                  transform="translate(3029, 0)"
                ></use>
              </g>
              <g
                data-mml-node="mo"
                transform="translate(6697.8, 0)"
              >
                <use xlink:href="#MJX-5-TEX-N-D7"></use>
              </g>
              <g
                data-mml-node="mfrac"
                transform="translate(7698, 0)"
              >
                <g
                  data-mml-node="mtext"
                  transform="translate(220, 676)"
                >
                  <use xlink:href="#MJX-5-TEX-N-64"></use>
                  <use
                    xlink:href="#MJX-5-TEX-N-6F"
                  ...
                  <use
                    ...
                    transform="translate(2459, 0)"
                  ></use>
                  <use
                    xlink:href="#MJX-5-TEX-N-63"
                    transform="translate(2737, 0)"
                  ></use>
                  <use
                    xlink:href="#MJX-5-TEX-N-6C"
                    transform="translate(3181, 0)"
                  ></use>
                  <use
                    xlink:href="#MJX-5-TEX-N-69"
                    transform="translate(3459, 0)"
                  ></use>
                  <use
                    xlink:href="#MJX-5-TEX-N-65"
                    transform="translate(3737, 0)"
                  ></use>
                  <use
                    xlink:href="#MJX-5-TEX-N-6E"
                    transform="translate(4181, 0)"
                  ></use>
                  <use
                    xlink:href="#MJX-5-TEX-N-74"
                    transform="translate(4737, 0)"
                  ></use>
                  <use
                    xlink:href="#MJX-5-TEX-N-57"
                    transform="translate(5126, 0)"
                  ></use>
                  <use
                    xlink:href="#MJX-5-TEX-N-69"
                    transform="translate(6154, 0)"
                  ></use>
                  <use
                    xlink:href="#MJX-5-TEX-N-64"
                    transform="translate(6432, 0)"
                  ></use>
                  <use
                    xlink:href="#MJX-5-TEX-N-74"
                    transform="translate(6988, 0)"
                  ></use>
                  <use
                    xlink:href="#MJX-5-TEX-N-68"
                    transform="translate(7377, 0)"
                  ></use>
                </g>
                <g
                  data-mml-node="mtext"
                  transform="translate(1961.5, -686)"
                >
                  <use xlink:href="#MJX-5-TEX-N-64"></use>
                  <use
                    xlink:href="#MJX-5-TEX-N-65"
                  ...
                  <use
                    xlink:href="#MJX-5-TEX-N-69"
                    transform="translate(1394, 0)"
                  ></use>
                  <use
                    xlink:href="#MJX-5-TEX-N-67"
                    transform="translate(1672, 0)"
                  ></use>
                  <use
                    xlink:href="#MJX-5-TEX-N-6E"
                    transform="translate(2172, 0)"
                  ></use>
                  <use
                    xlink:href="#MJX-5-TEX-N-53"
                    transform="translate(2728, 0)"
                  ></use>
                  <use
                    xlink:href="#MJX-5-TEX-N-69"
                    transform="translate(3284, 0)"
                  ></use>
                  <use
                    xlink:href="#MJX-5-TEX-N-7A"
                    transform="translate(3562, 0)"
                  ></use>
                  <use
                    xlink:href="#MJX-5-TEX-N-65"
                    transform="translate(4006, 0)"
                  ></use>
                </g>
                <rect
                  width="8133"
        ...
        <!-- 公式原理详细介绍 -->
        <p>
          此公式的主要目标是根据当前浏览器窗口的宽度（<code>docEl.clientWidth</code>），结合设计稿的尺寸（<code>designSize</code>）和基础字体大小（<code>fontSize</code>），动态地计算出
          HTML
          根元素（<code>&lt;html&gt;</code>）的字体大小（<code>rem</code>），从而实现页面的响应式布局。
        </p>
        <h4>公式各部分含义</h4>
        <ol>
          <li>
            <strong><code>fontSize</code></strong
            >：这是基础字体大小，它是一个固定的值，存储在
            <code>window.ZyFontSize</code>
            中。在响应式布局中，它作为计算的基础，所有后续的字体大小调整都是基于这个基础值进行的。
          </li>
          <li>
            <strong><code>docEl.clientWidth</code></strong
            >：表示当前 HTML
            文档根元素（<code>&lt;html&gt;</code>）的可视宽度，即浏览器窗口的宽度。这个值会随着用户调整浏览器窗口大小而动态变化。
          </li>
          <li>
            <strong><code>designSize</code></strong
            >：它是根据当前窗口宽度和屏幕方向从
            <code>window.ZyDesignSize</code>
        ...
        <ol>
          <li>
            <strong>计算比例</strong>：首先计算
            <code>docEl.clientWidth</code> 与 <code>designSize</code> 的比值，即
            <code>docEl.clientWidth / designSize</code
            >。这个比值表示当前窗口宽度相对于设计稿尺寸的比例。例如，如果设计稿宽度为
            375px，而当前窗口宽度为 750px，那么这个比值就是
            2，表示当前窗口宽度是设计稿宽度的 2 倍。
          </li>
          <li>
            <strong>计算 <code>rem</code> 值</strong>：将基础字体大小
            <code>fontSize</code> 乘以这个比例，得到最终的
            <code>rem</code> 值。这样，<code>rem</code>
            值就会随着窗口宽度的变化而动态调整。例如，如果基础字体大小为
            16px，当前窗口宽度是设计稿宽度的 2 倍，那么计算得到的
            <code>rem</code> 值就是 <code>16 × 2 = 32</code>px。
          </li>
          <li>
            <strong>设置根元素字体大小</strong>：最后将计算得到的
            <code>rem</code> 值加上 <code>px</code> 单位，并设置为 HTML
            根元素的字体大小。由于页面中的其他元素可以使用
            <code>rem</code>
        ...
        <h3>技术细节</h3>
        <p>
          在项目开发时，可以结合 Tailwind CSS 的
          <code>responsive modifiers</code> 响应修饰符特性，结合
          <code>rem</code> 单位，实现页面的响应式布局。<br />
          例如一个完整的文章列表的 Grid 布局，具体的 Tailwind ClassName
          实现方式如下：<br />
        </p>
...
.clo-article-card {
  @apply portrait:col-span-12 landscape:col-span-12
        ...
        <br />
        <p>
          像这样结合使用 <code>portrait:</code> 方向断点前缀和
          <code>xs:</code> 宽度断点前缀，即可分别设置12种屏的样式。
        </p>
        <p>
          而对于自适应字号，知鸢宫的超级响应式组件
          <code>ZySuperResponsive</code> ，已经自动处理了通过 JavaScipt 实现动态
          HTML 根元素字号大小的设计。只需要开发者编写CSS样式时使用
          <code>rem</code> 单位，或者直接使用 TailWind CSS
          。因为它默认就是采用的 <code>rem</code> 单位。
        </p>
...
const fontSizeInit = () => {
  ...
  if (docEl) {
    ...
    docEl.style.fontSize = rem + "px";
        ...
        <p>
          该核心方法中使用了 <code>document</code> 对象，在 SSR
          服务端渲染时不存在
          <code>document</code> 对象，因此需要通过一些方法使其只在客户端运行。
        </p>
        <p>
          为了在页面元素及其他页面样式加载之前，就提前自动初始化该样式，并且兼容
          SSR 服务端渲染，<code>ZySuperResponsive</code>
          组件在服务端渲染时，通过 NUXT3 的 <code>useHead()</code> 方法，在 html
          头部插入标签，包括 <code>window.ZyFontSize</code> 和
          <code>window.ZyDesignSize</code>
          等全局变量，以及一些需要客户端优先加载的样式类脚本，来动态设置 HTML
          根元素的字体大小。<br />
          具体的实现方法如下：<br />
        </p>
