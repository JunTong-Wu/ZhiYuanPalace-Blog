  ...
  <div class="relative bg-level-1">
    <div class="container flex portrait:flex-col relative py-12 portrait:pt-0">
      ...
      <div
        ...
        <span class="text-theme-500 landscape:sm:text-2xl font-bold mb-2 landscape:sm:mb-4">音乐</span>
        ...
        landscape:gap-12 landscape:sm:mt-12 landscape:sm:gap-24
        portrait:gap-12 portrait:justify-center
        ">
          <div class="flex">
            <ZyButton class="aspect-square" title="上一曲" type="transparent" @click="musicPrev">
              <UIcon name="i-solar-skip-previous-bold" class="w-12 h-12 portrait:w-8 portrait:h-8" />
            </ZyButton>
          </div>
          <div class="flex">
            <ZyButton class="aspect-square text-theme-500" title="播放" type="transparent" @click="togglePlay">
              <template v-if="musicPlayState">
                <UIcon name="i-solar-pause-circle-bold" class="w-24 h-24 portrait:w-16 portrait:h-16" />
              </template>
              <template v-else>
                <UIcon name="i-solar-play-circle-bold" class="w-24 h-24 portrait:w-16 portrait:h-16" />
              </template>
            </ZyButton>
          </div>
          <div class="flex">
            <ZyButton class="aspect-square" title="下一曲" type="transparent" @click="musicNext">
              <UIcon name="i-solar-skip-next-bold" class="w-12 h-12 portrait:w-8 portrait:h-8" />
            </ZyButton>
          </div>
          <!-- <div>
