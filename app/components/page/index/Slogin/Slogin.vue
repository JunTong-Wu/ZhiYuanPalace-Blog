  ...
  <div class="relative bg-level-1 landscape:mt-24 landscape:sm:mt-64 ">
    <div class="container flex portrait:flex-col relative portrait:mt-0">
      ...
      <div
        ...
        <span class="text-theme-500 landscape:sm:text-2xl font-bold mb-2 landscape:sm:mb-4">知鸢宫的含义</span>
...
@media (orientation: landscape) {
  .home-section2-image {
    &::after {
      ...
      width: 100%;
      height: 100%;
      background: url("@/assets/image/home-section2.png") no-repeat center/cover;
