  ...
  <aside id="zy-music-bar" class="h-music">
    <div
      ...
      <div class="flex flex-none relative h-[120%] aspect-square landscape:h-16 landscape:left-4 landscape:top-4">
        ...
        <img v-if="!isLoading" class="h-full relative left-0 rounded-md portrait:shadow-md" :src="musicNowCover" alt=""
          srcset="" ref="MusicCoverImageRef" @load="createDecoration()" />
      ...
      <div
        ...
        <p
          class="flex-1 landscape:line-clamp-2 portrait:line-clamp-1 text-xs landscape:text-sm landscape:mt-3 landscape:text-white">
          你说的话 有心的吗 刺痛我了 无意的吧
        </p>
      </div>
      <div
        ...
        <div class="portrait:hidden">
          <ZyButton class="portrait:h-music aspect-square" title="上一曲" type="transparent">
            <ZyIcon class="landscape:hidden" size="1rem" defaultName="music-prev" />
            <ZyIcon class="portrait:hidden" size="1.25rem" defaultName="music-prev" />
          </ZyButton>
        </div>
        <div>
          <ZyButton class="portrait:h-music aspect-square" title="播放" type="transparent">
            <ZyIcon class="landscape:hidden" size="1rem" defaultName="music-play" />
            <ZyIcon class="portrait:hidden" size="2rem" defaultName="music-play" />
          </ZyButton>
        </div>
        <div class="portrait:hidden">
          <ZyButton class="portrait:h-music aspect-square" title="下一曲" type="transparent">
            <ZyIcon class="landscape:hidden" size="1rem" defaultName="music-next" />
            <ZyIcon class="portrait:hidden" size="1.25rem" defaultName="music-next" />
          </ZyButton>
        </div>
        <div>
