  ...
  <aside id="zy-music-bar">
    ...
    >
      ...
      >
        <img
          v-if="!isLoading"
          class="h-full w-full object-cover blur-3xl"
      ...
      <div
        class="absolute top-0 right-0 -z-1 w-full h-full bg-[rgba(0,0,0,0.4)] dark:bg-[rgba(0,0,0,0.6)]"
      ></div>
      <div class="open:hidden flex flex-none relative h-full aspect-square">
        <img
          class="h-[80%] absolute bottom-[10%] drop-shadow-md left-6 portrait:drop-shadow-none"
        ...
        <img
          v-if="!isLoading"
          class="h-full relative left-0 rounded-2xs shadow-md portrait:shadow-none"
          :src="`${cdnUrl}${musicNowCover}`"
          alt=""
          srcset=""
      ...
      <div class="open:hidden flex">
        <div class="flex">
          <ZyButton
            class="h-music aspect-square hover:bg-[rgba(255,255,255,0.2)]"
            title="上一曲"
            type="transparent"
    ...
    <ClientOnly>
      <Teleport to="body">
        ...
        >
          ...
          <div
            class="zy-music-drawer-inner absolute top-0 right-0 z-1 w-full h-full text-white flex justify-center"
          >
            <div
            ...
            >
              <div
                class="landscape:w-1/2 portrait:w-full flex flex-col justify-center items-center"
              >
                <div
                  class="portrait:hidden w-1/2 landscape:md:w-2/3 aspect-square inline-block"
                >
                ...
                >
                  <div class="flex w-full justify-between">
                    ...
                    <div class="">
                      <ZyButton
                        type="transparent"
                        class="bg-[rgba(255,255,255,0.1)] p-2 rounded-full"
                        title="歌曲操作"
                      >
                        <UIcon
                        ...
                        >
                          <template v-if="musicPlayState">
                            <UIcon
                              ...
                              class="w-9 h-9 portrait:w-6 portrait:h-6"
                            />
                          </template>
                          <template v-else>
                            <UIcon
